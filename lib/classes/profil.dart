...
class ProfilePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: Column(
        children: [
          const Expanded(flex: 5, child: _TopPortion()),
          Expanded(
            flex: 4,
            child: Padding(
...
class _TopPortion extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Stack(
      ...
      children: [
        Container(
          margin: const EdgeInsets.only(bottom: 20), // centrage vertical de la photo
        ...
        Align(
          ...
          child: SizedBox(
            width: 50, // diamètre de la photo
            height: 50,  // diamètre de la photo
            child: Stack(
              fit: StackFit.expand,
              children: [
                Container(
